...
from toolkit.utils import AgeGenderHelper
import numpy as np
import progressbar
import pickle
import json
...
# build the set of image paths and class labels
print("[INFO] building paths and labels...")
helper = AgeGenderHelper(config)
(trainPaths, trainLabels) = helper.buildPathsAndLabels()

# compute the number of images to use for validation and testing
